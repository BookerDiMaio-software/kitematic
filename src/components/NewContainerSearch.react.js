        ...
        <div className="new-container">
          <div className="new-container-header">
            ...
            <div className={searchClasses}>
              <input type="search" ref="searchInput" className="form-control" placeholder="Search for Docker images from Docker Hub" defaultValue="cameronavelisbooker" onChange={this.handleChange}/>
